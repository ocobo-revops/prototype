...
const ServiceCard: React.FC<ServiceCardProps> = ({
	...
	return (
		<div
			className={`group relative p-8 h-full ${currentTheme.bg} border-l-4 ${currentTheme.border} transition-all duration-300 hover:shadow-lg flex flex-col justify-between`}
		>
			<div>
				<div className="mb-6">
					{icon && (
						<div className="p-3 bg-white w-fit rounded-lg shadow-sm text-ocobo-dark">
							{icon}
						</div>
					)}
				</div>
			...
			<div className="mt-auto">
				<span
					className={`inline-flex items-center text-xs font-bold uppercase tracking-wider text-ocobo-dark border-b border-transparent ${currentTheme.hover} transition-colors`}
				>
