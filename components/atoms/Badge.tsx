...
const Badge: React.FC<BadgeProps> = ({
	...
	const variants: Record<BadgeVariant, string> = {
		[ThemeColor.YELLOW]:
			'text-ocobo-dark bg-ocobo-yellowLight border-ocobo-yellow/20',
		[ThemeColor.MINT]:
			'text-ocobo-dark bg-ocobo-mintLight border-ocobo-mint/20',
		[ThemeColor.SKY]: 'text-ocobo-sky bg-ocobo-skyLight border-ocobo-sky/20',
		[ThemeColor.CORAL]:
			'text-ocobo-coral bg-ocobo-coralLight border-ocobo-coral/20',
		[ThemeColor.DARK]: 'text-white bg-ocobo-dark border-ocobo-dark/20',
		gray: 'text-gray-400 bg-gray-100 border-gray-200',
	};

	const sizes = {
		sm: 'px-4 py-1.5 text-2xs tracking-[0.3em]',
