	...
	return (
		...
		>
			{!isExpanded ? (
				...
				<div className="bg-ocobo-dark text-white p-6 rounded-4xl shadow-[0_30px_100px_-20px_rgba(0,0,0,0.5)] border border-white/10 w-[320px] relative overflow-hidden">
