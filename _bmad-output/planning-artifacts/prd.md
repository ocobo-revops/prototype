...
- Design System Showcase page (hors navigation) présentant tous les composants
...
- **Design System Showcase page** (hidden route, hors navigation) presenting all tokens and components visually
...
- **FR23:** Developer can access a dedicated page showcasing all DS components (route: `/design-system` ou similaire)
