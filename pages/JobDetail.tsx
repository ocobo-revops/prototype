			...
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				...
				<div className="flex flex-col lg:flex-row gap-16 relative">
							...
							<div className="mt-20 p-8 bg-ocobo-dark rounded-2xl text-white relative overflow-hidden shadow-xl">
								...
								<ul className="space-y-4 mb-8">
									{[
										...
										<li
											key={i}
											className="flex items-start gap-3 text-[10px] font-bold uppercase tracking-widest text-gray-400"
										>
											<Plus
												size={12}
								...
								<a href="#apply">
									<button className="w-full py-3 bg-ocobo-yellow text-ocobo-dark font-black text-[10px] uppercase tracking-widest rounded-lg hover:bg-white transition-colors">
										Postuler maintenant
									</button>
								</a>
							</div>
					...
					<article className="lg:w-3/4 max-w-3xl">
						...
						<div
							id="apply"
							className="mt-24 bg-ocobo-yellow p-10 md:p-14 rounded-[2.5rem] relative overflow-hidden shadow-2xl scroll-mt-40"
						>
								...
								<form className="space-y-8 max-w-2xl">
									<div className="grid md:grid-cols-2 gap-6">
										<div className="space-y-2">
											<label className="text-[10px] font-black uppercase tracking-[0.3em] text-ocobo-dark opacity-50">
												Prénom Nom*
											</label>
											<input
												type="text"
									...
									<div className="space-y-2">
										...
										<div className="border-2 border-dashed border-ocobo-dark/10 p-10 text-center bg-white/40 rounded-2xl hover:bg-white transition-all cursor-pointer group">
											<FileText
												...
												size={32}
											/>
											<p className="text-[10px] font-black uppercase tracking-widest text-ocobo-dark/40 group-hover:text-ocobo-dark transition-colors">
								...
								{[
									...
									>
										<div className="flex items-center gap-3 mb-4">
											<span className="text-[9px] font-black uppercase tracking-widest text-ocobo-coral bg-ocobo-coralLight px-2 py-0.5 border border-ocobo-coral/10">
												{other.exp}
											</span>
