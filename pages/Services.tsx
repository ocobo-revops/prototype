			...
			<section className="py-16 md:py-24 bg-white">
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					...
					<div className="space-y-24">
						...
						<div className="flex flex-col md:flex-row gap-12 md:gap-24 items-start">
							<div className="w-full md:w-5/12 sticky top-32">
								<div className="w-16 h-16 bg-ocobo-coral text-ocobo-dark flex items-center justify-center font-display font-bold text-2xl border border-ocobo-dark shadow-[4px_4px_0px_0px_rgba(33,35,35,1)] mb-8">
									2
								</div>
								<h3 className="font-display text-3xl md:text-4xl font-bold text-ocobo-dark mb-4 leading-tight">
					...
					<div className="grid lg:grid-cols-3 gap-12 lg:gap-8">
						...
						<Link to="/method" className="group flex flex-col h-full">
							<div className="relative p-10 bg-gray-50 rounded-[2.5rem] border border-gray-100 flex-grow transition-all duration-500 hover:shadow-2xl hover:bg-white hover:-translate-y-2 overflow-hidden flex flex-col">
								...
								<p className="text-gray-400 font-display font-black text-[10px] uppercase tracking-widest mb-4">
								...
								<div className="flex flex-wrap gap-2 h-[48px] content-start">
									{['Alignment', 'Technology', 'Performance', 'Enablement'].map(
										(tag) => (
											<span
												key={tag}
												className="px-3 py-1 bg-white border border-gray-100 rounded-full text-[9px] font-black uppercase tracking-wider text-gray-400"
											>
												{tag}
											</span>
										),
