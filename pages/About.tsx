		...
		<div className="w-full">
					...
					<div className="space-y-12 md:space-y-20 max-w-3xl">
						...
						<div className="space-y-4 border-l-4 border-ocobo-yellow pl-8 py-2">
							...
							<p className="text-xl md:text-3xl font-bold text-ocobo-yellow leading-tight italic">
								C’est une discipline stratégique : l’architecture de votre
								revenu.
							</p>
						</div>
						...
						<div className="space-y-4 pt-10">
							...
							<p className="text-xl md:text-3xl font-medium text-white leading-tight">
								Mais le résultat d’une architecture juste, d’une mécanique
								revenue qui respire et d’une exigence d’alignement.
							</p>
						</div>
					...
					<div className="grid md:grid-cols-3 gap-8">
						...
						<div className="bg-white p-8 border border-gray-100 shadow-sm hover:shadow-lg transition-all text-center">
							<div className="w-32 h-32 mx-auto mb-6 rounded-full overflow-hidden border-4 border-ocobo-yellow">
								<img
									src="https://placehold.co/200x200/F3F4F6/F3F4F6"
							...
							<p className="text-gray-600 text-sm mb-6 leading-relaxed">
								12+ ans en Ops, CRM, Product et Revenue Operations (TheFork,
								Tripadvisor, Yousign). Spécialiste des systèmes et du pilotage
								opérationnel.
							</p>
							<a
								href="#"
						...
						<div className="bg-white p-8 border border-gray-100 shadow-sm hover:shadow-lg transition-all text-center">
							...
							<p className="text-gray-600 text-sm mb-6 leading-relaxed">
								Référence française du Revenue Operations (TheFork, Spendesk).
								Experte du customer journey, des organisations GTM, du scaling
								d’équipes RevOps.
							</p>
							<a
								href="#"
						...
						<div className="bg-white p-8 border border-gray-100 shadow-sm hover:shadow-lg transition-all text-center">
							...
							<p className="text-gray-600 text-sm mb-6 leading-relaxed">
								Finance, Deloitte, Business Ops (TheFork). Spécialiste du
								forecasting, de la performance, des rémunérations variables et
								du pricing.
							</p>
							<a
								href="#"
			...
			<section className="py-24 bg-ocobo-dark text-white">
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					...
					<div className="grid md:grid-cols-2 gap-x-16 gap-y-12">
						<div>
							<h3 className="text-ocobo-yellow font-display text-2xl font-bold mb-4">
								Clarté radicale
							</h3>
						...
						<div>
							<h3 className="text-ocobo-mint font-display text-2xl font-bold mb-4">
						...
						<div>
							<h3 className="text-ocobo-sky font-display text-2xl font-bold mb-4">
								Exigence senior
							</h3>
							<p className="text-gray-300">
								Des profils qui ont vécu les enjeux, les crises, les
								restructurations.
							</p>
							<p className="text-sm text-gray-500 mt-2 italic">
						...
						<div>
							<h3 className="text-ocobo-coral font-display text-2xl font-bold mb-4">
								Architecture avant la maçonnerie
							</h3>
							<p className="text-gray-300">
								Pas d’outil sans intention. Pas d’automatisation sans vision. Il
								ne suffit pas de connecter les tuyaux, encore faut-il que l'eau
								circule.
							</p>
							<p className="text-sm text-gray-500 mt-2 italic">
						...
						<div>
							...
							<p className="text-gray-300">
								Concevoir pour les équipes. Fluidifier leur quotidien.
							</p>
							<p className="text-sm text-gray-500 mt-2 italic">
								→ Si l’usage casse, tout trépasse
							</p>
						</div>
						<div>
							<h3 className="text-white font-display text-2xl font-bold mb-4">
								Anti-bullshit technologique
							</h3>
							<p className="text-gray-300">
								Pas de promesses miracles. Pas d’IA gadget.
							</p>
							<p className="text-sm text-gray-500 mt-2 italic">
								→ La technologie est un levier, pas un totem
							</p>
						</div>
					</div>
				</div>
			...
			<section className="bg-ocobo-skyLight py-24 text-center">
				<div className="max-w-3xl mx-auto px-4">
					...
					<p className="text-lg text-ocobo-dark font-medium mb-10">
