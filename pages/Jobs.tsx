		...
		<div className="w-full pt-32 pb-24 bg-white">
			...
			<section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 mb-16">
				<div className="text-center mb-20">
					<span className="font-display font-black text-ocobo-coral bg-ocobo-coral-light px-4 py-1.5 text-2xs uppercase tracking-[0.3em] mb-6 inline-block border border-ocobo-coral/20 rounded-full">
						NOTRE ADN
					</span>
