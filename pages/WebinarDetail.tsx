		...
		<div className="w-full pt-40 pb-24 bg-white font-sans">
			...
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				...
				<div className="mb-12">
					<Link
						to="/resources"
						className="inline-flex items-center text-gray-400 hover:text-ocobo-dark font-black uppercase tracking-[0.2em] text-[10px] transition-colors"
					>
						...
						<div className="sticky top-32">
							<div className="p-10 bg-ocobo-dark rounded-[2.5rem] text-white shadow-2xl relative overflow-hidden">
								...
								<Link to="/contact" className="block">
									<Button
										variant="white"
										className="w-full !py-4 text-[10px] font-black uppercase tracking-widest border-none hover:bg-ocobo-sky hover:text-white transition-all"
									>
							...
							<div className="mt-8 p-8 border border-gray-100 rounded-3xl bg-white shadow-sm hover:shadow-md transition-all group cursor-pointer">
								<span className="text-[8px] font-black text-ocobo-coral uppercase tracking-widest mb-2 block">
									Dernier Article
								</span>
				...
				<div className="mt-40 pt-20 border-t border-gray-100">
					<div className="flex items-center justify-between mb-12">
						...
						<Link
							to="/resources"
							className="text-[10px] font-black uppercase tracking-[0.3em] text-gray-400 hover:text-ocobo-dark transition-colors flex items-center gap-2"
						>
					...
					<div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
						{[1, 2].map((i) => (
							<div key={i} className="group cursor-pointer">
								...
								<span className="font-display font-black text-[9px] uppercase tracking-[0.2em] text-ocobo-sky mb-3 block">
									WEBINAR
								</span>
