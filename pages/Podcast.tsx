    ...
    <div className="w-full bg-white">
      ...
      <section className="sticky top-[80px] z-50 bg-white/90 backdrop-blur-md border-b border-gray-100 py-6">
          <div className="max-w-3xl mx-auto px-4 flex flex-col md:flex-row items-center justify-center gap-6">
              <div className="relative w-full group">
                  ...
                  />
                  <Search size={20} className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 group-focus-within:text-ocobo-dark transition-colors" />
              </div>
          </div>
      </section>
      ...
      <section className="py-24 bg-gray-50 border-y border-gray-100">
          <div className="max-w-4xl mx-auto px-4 text-center">
              ...
              <h2 className="font-display text-3xl font-bold text-ocobo-dark mb-4">Animé par Aude Cadiot</h2>
              ...
              <div className="flex justify-center gap-4">
                  ...
                  <a href="#" className="text-gray-400 hover:text-ocobo-dark transition-colors"><Share2 size={20} /></a>
              </div>
          </div>
      </section>
