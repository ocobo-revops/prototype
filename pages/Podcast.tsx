      ...
      `}</style>
					...
					<div className="flex flex-col lg:flex-row items-center gap-16">
						<div className="lg:w-1/2">
							<div className="flex items-center gap-3 mb-8">
								...
								<span className="font-display font-black text-ocobo-yellow text-[10px] uppercase tracking-[0.4em]">
									Ocobo Originals
								</span>
							</div>
						...
						<div className="lg:w-1/2">
							<div className="bg-white/5 backdrop-blur-xl border border-white/10 p-8 md:p-12 rounded-[3rem] shadow-2xl relative">
								...
								<div className="flex items-center gap-6 mb-10">
									...
									<div>
										<span className="text-[10px] font-black text-ocobo-yellow uppercase tracking-[0.3em] block mb-2">
					...
					{filteredEpisodes.length > 0 ? (
								...
								<div className="flex flex-col justify-between py-2 flex-grow">
									<div>
										<div className="flex items-center gap-3 mb-4">
											<span className="text-[10px] font-black uppercase tracking-[0.2em] text-ocobo-yellow">
												{ep.category}
											</span>
									...
									<div className="flex items-center justify-between border-t border-gray-50 pt-6 mt-auto">
										<div className="flex items-center gap-4">
											...
											<div>
												<p className="text-[11px] font-black text-ocobo-dark uppercase tracking-widest leading-none mb-1">
													{ep.guest}
												</p>
						...
						<div className="text-center py-20 bg-gray-50 rounded-[3rem] border border-dashed border-gray-200">
							...
							<button
								...
								className="mt-4 text-ocobo-dark font-black uppercase tracking-widest text-[10px] underline"
							>
			...
			<section className="bg-ocobo-yellow py-32 relative overflow-hidden">
				<div className="max-w-4xl mx-auto px-4 text-center relative z-10">
					<span className="font-display font-black text-ocobo-dark opacity-30 text-[11px] uppercase tracking-[0.4em] mb-8 inline-block">
						Prochainement
					</span>
